                ...
                <table class="table table-striped table-bordered mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('customers.show',$customer->id) }}" class="btn btn-outline-secondary">{{__('admin.View')}}</a>
                                <button class="btn btn-outline-success edit-button" data-toggle="modal" data-target="#editModal" data-id="{{$customer->id}}" id="edit-button-{{$customer->id}}">{{__('admin.Edit')}}</button>
