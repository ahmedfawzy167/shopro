    ...
    <div class="row">
        <div class="card-body text-center">
            ...
            <div class="table-responsive">
                <h1 class="text-center bg-primary text-light"><i class="fas fa-trash"></i> {{__('admin.Trashed Products')}}</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('products.restore',$product->id) }}" method="post" style="display: inline-block">
                                 ...
                                 <button type="submit" class="btn btn-outline-danger" data-toggle="modal" data-target="#productModal">{{__('admin.Delete')}}</button>
                            </td>
                        </tr>
