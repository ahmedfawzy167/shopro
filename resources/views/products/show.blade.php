...
<div class="d-flex justify-content-center align-items-center vh-60">
    <div class="card" style="width: 60rem;">
      <div class="card-body">
        <h2 class="card-title text-center bg-success"><i class="fa-solid fa-eye"></i> {{__('admin.Product Details')}}</h2>
      </div>
      <ul class="list-group list-group-flush">
        ...
        <div class="d-flex">
            @foreach($product->skus as $sku)
                <img src="{{asset('storage/'.$sku->image)}}" width="100px" class="mr-2">
            @endforeach
        </div>
       </li>
