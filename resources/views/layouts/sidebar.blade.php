    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="usersCollapse" class="collapse" aria-labelledby="headingUsers" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('users.create')}}"><i class="fa-solid fa-plus"></i> {{__('admin.Add New User')}}</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('products.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Products')}}</a>
                    <a class="collapse-item" href="{{route('products.create')}}"><i class="fa-solid fa-plus"></i> {{__('admin.Add New Product')}}</a>
                    <a class="collapse-item" href="{{route('products.trash')}}"><i class="fas fa-trash"></i> {{__('admin.All Trashed Products')}}</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('categories.create')}}"><i class="fa-solid fa-plus"></i> {{__('admin.Add New Category')}}</a>
                    <a class="collapse-item" href="{{route('categories.trash')}}"><i class="fas fa-trash"></i> {{__('admin.Trashed Categories')}}</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapsesubcategories" class="collapse" aria-labelledby="headingsubcategories"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('subcategories.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Subcategories')}}</a>
                    <a class="collapse-item" href="{{route('subcategories.create')}}"><i class="fa-solid fa-plus"></i> {{__('admin.Add New Subcategory')}}</a>
                    <a class="collapse-item" href="{{route('subcategories.trash')}}"><i class="fas fa-trash"></i> {{__('admin.Trashed Subcategories')}}</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseskus" class="collapse" aria-labelledby="headingskus"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('skus.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Skus')}}</a>
                    <a class="collapse-item" href="{{route('skus.create')}}"><i class="fa-solid fa-plus"></i> {{__('admin.Add New Sku')}}</a>
                </div>
            </div>
        </li>
...
<li class="nav-item">
    ...
    <div id="collapseCustomers" class="collapse" aria-labelledby="headingCustomers"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('customers.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Customers')}}</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseCities" class="collapse" aria-labelledby="headingCities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('cities.trash')}}"><i class="fas fa-trash"></i> {{__('admin.All Trashed Cities')}}</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseOrders" class="collapse" aria-labelledby="headingCities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('orders.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Orders')}}</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapsespecs" class="collapse" aria-labelledby="headingspecs"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('specs.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Specs')}}</a>
        </div>
    </div>
</li>
...
<!-- Divider -->
  <hr class="sidebar-divider d-none d-md-block">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="get" action="{{route('search')}}">
                    ...
                    <div class="input-group">
                        <input type="text" name="term" class="form-control bg-light border-0 small" placeholder="{{__('admin.Search for')}}..."
    ...
    <div class="dropdown-menu" aria-labelledby="languageDropdown">
      <a class="dropdown-item" href="{{ route('change.language',['locale' => 'en']) }}"><img src="{{asset('assets/img/england.png')}}" class="rounded-circle" width="30px"> English - EN</a>
      <a class="dropdown-item" href="{{ route('change.language', ['locale' => 'ar']) }}"><img src="{{asset('assets/img/egypt.png')}}" class="rounded-circle" width="30px"> العربية - AR</a>
    </div>
    </div>
