...
<div class="d-flex justify-content-center align-items-center vh-60">
    <div class="card" style="width: 60rem;">
      <div class="card-body">
        <h2 class="card-title text-center bg-success"><i class="fa-solid fa-eye"></i> {{__('admin.Spec Details')}}</h2>
      </div>
  ...
  <div class="text-center mt-2">
     <a href="{{route('specs.index')}}" class="btn btn-success">{{__('admin.Back to List')}}</a>
  </div>
