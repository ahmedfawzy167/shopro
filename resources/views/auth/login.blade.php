            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              <form action="{{ route('login') }}" method="POST">
                ...
                <div class="text-center">
                  <a class="btn btn-lg w-100 text-white"  style="background-color: #3b5998;" href="#!">
                  <i class="fab fa-facebook-f me-2"></i>Login with Facebook
                </a>
                  <a class="btn btn-lg mt-3 w-100 text-white" href="#!" style="background-color: #55acee">
                  <i class="fab fa-twitter me-2"></i>Login with Twitter</a>

                  <a class="btn btn-success btn-lg mt-3 w-100 text-white" href="{{route('register')}}">
